fun main() {
    ...
    val entrada = readln() // ler a entrada do usuário em String
    val escalaI: Char = entrada[0] // atribui valor à variável Char passando o caractere na posição 0 da String
